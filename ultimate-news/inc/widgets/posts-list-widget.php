<?php
if ( ! class_exists( 'Ultimate_News_Posts_List_Widget' ) ) {
	/**
	 * Adds Ultimate_News_Posts_List_Widget Widget.
	 */
	class Ultimate_News_Posts_List_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'ultimate_news_magazine_list_widget',
				__( 'Ascendoor Posts List Widget', 'ultimate-news' ),
