<?php
if ( ! class_exists( 'Ultimate_News_Posts_Grid_And_List_Widget' ) ) {
	/**
	 * Adds Ultimate_News_Posts_Grid_And_List_Widget Widget.
	 */
	class Ultimate_News_Posts_Grid_And_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ultimate_news_grid_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-list-section style-1',
				'description' => __( 'Retrive Posts Grid And List Widgets', 'ultimate-news' ),
			);
			parent::__construct(
				'ultimate_news_magazine_grid_list_widget',
				__( 'Ascendoor Grid And List Widget', 'ultimate-news' ),
				$ultimate_news_grid_list_widget_ops
			);
		}
							...
							<div class="mag-post-single has-image <?php echo esc_attr( 1 === $i ? '' : 'list-design' ); ?>">
								...
								<div class="mag-post-detail">
									<div class="mag-post-category">
										<?php ultimate_news_categories_list(); ?>
									</div>
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Section Title:', 'ultimate-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'ultimate-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'ultimate-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show( Min:1 | Max:5 ):', 'ultimate-news' ); ?></label>
				<input class="tiny-text" id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" step="1" min="1" max="5" value="<?php echo absint( $grid_list_post_count ); ?>" size="3" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'ultimate-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'ultimate-news' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = ultimate_news_get_post_cat_choices();
