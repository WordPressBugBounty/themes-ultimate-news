<?php
if ( ! class_exists( 'Ultimate_News_Posts_Small_List_Widget' ) ) {
	/**
	 * Adds Ultimate_News_Posts_Small_List_Widget Widget.
	 */
	class Ultimate_News_Posts_Small_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ultimate_news_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-small-list-section style-1',
				'description' => __( 'Retrive Posts List Widgets', 'ultimate-news' ),
			);
			parent::__construct(
				'ultimate_news_magazine_small_list_widget',
				__( 'Ascendoor Posts Small List Widget', 'ultimate-news' ),
				$ultimate_news_list_widget_ops
			);
		}
