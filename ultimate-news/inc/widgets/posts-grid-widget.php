<?php
if ( ! class_exists( 'Ultimate_News_Posts_Grid_Widget' ) ) {
	/**
	 * Adds Ultimate_News_Posts_Grid_Widget Widget.
	 */
	class Ultimate_News_Posts_Grid_Widget extends WP_Widget {
		...
		public function __construct() {
			$ultimate_news_grid_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-section style-1',
				'description' => __( 'Retrive Posts Grid Widgets', 'ultimate-news' ),
			);
			parent::__construct(
				'ultimate_news_magazine_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'ultimate-news' ),
				$ultimate_news_grid_widget_ops
			);
		}
