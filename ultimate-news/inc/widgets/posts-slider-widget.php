<?php
if ( ! class_exists( 'Ultimate_News_Posts_Slider_Widget' ) ) {
	/**
	 * Adds Ultimate_News_Posts_Slider_Widget Widget.
	 */
	class Ultimate_News_Posts_Slider_Widget extends WP_Widget {
		...
		public function __construct() {
			$ultimate_news_posts_slider_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-post-slider-section style-1',
				'description' => __( 'Retrive Posts Slider Widgets', 'ultimate-news' ),
			);
			parent::__construct(
				'ultimate_news_magazine_post_slider_widget',
				__( 'Ascendoor Posts Slider Widget', 'ultimate-news' ),
				$ultimate_news_posts_slider_widget_ops
			);
		}
