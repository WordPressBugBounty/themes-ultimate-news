jQuery(function($) {
    ...
    Banner Slider
    ----------------------------------------- */
    $('.banner-section.style-2 .banner-grid-section').masonry({
    // options
    ...
    editor picks slider
    ----------------------------------------- */
    $('.banner-section.style-2 .editor-picks-wrapper.vertical').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        autoplay: true,
        infinite: true,
    ...
    Post Slider
    ----------------------------------------- */
    $('.magazine-post-slider-section.style-1 .post-slider').slick({
        autoplay: false,
        autoplaySpeed: 3000,
        dots: false,
        arrows: true,
